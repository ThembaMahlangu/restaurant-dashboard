...
export default function Register() {
  return (
    <div>
      <Head>
        <title>Register - Everything Foodie</title>
        ...
        <main className="flex-grow bg-cover bg-center" style={{ backgroundImage: "url('https://b.zmtcdn.com/data/pictures/chains/2/19889342/402a6114e65b6a8f30a70cca1a9b7cca.jpg')" }}>
          <div className="container mx-auto px-4 py-12">
            <div className="flex flex-col items-center space-y-6 py-20">
              <h2 className="text-3xl font-bold text-white">Register for Everything Foodie</h2>
              {/* Add your register form here */}
              <form className="flex flex-col space-y-4">
                <input required={true} type="text" placeholder="Full Name" className="px-4 py-2 rounded-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500" />
